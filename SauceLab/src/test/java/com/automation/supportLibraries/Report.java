...
public class Report extends BaseClass {
	...
	public static void passTestScreenshot(WebDriver driver, String stepDetails, String screenshotName) {
		try {
			if(driver!=null)
			{
				...
				String relativePath = "" + ResultFolderPathForScreenshot+"/" + screenshotPath;
				test.pass(MarkupHelper.createLabel(stepDetails, ExtentColor.GREEN));
